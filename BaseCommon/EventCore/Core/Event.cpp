...
namespace Logic
{
	...
	{		
#if DEVELOP_MODE
		if (hasState(STATE_EVENT_NO_LOG))
			return;
...
//#endif
	...
	//void tEvent::set( const char* szKey, const char* szVal, ... )
	//{
	//	va_list va;
	//	va_start(va, szVal);

	//	AString strValue;
	//	strValue.Format(va, szVal);

	//	set(szKey, strValue.c_str());
	//}
