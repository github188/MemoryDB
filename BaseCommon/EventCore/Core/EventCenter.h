...
namespace Logic
{
	...
	public:
		virtual bool _StartWaitTime(AutoEvent waitEvent, float waitSecond, EventCallBack callBack);
    ...
    protected:
        class EventArrayList : public Array<AutoEvent>
        {
        public:
			void _setEmpty(){ mCount = 0; }
		};
		class FreeEventList : public Array<tEvent*>
		{
		public:
			void _setEmpty(){ mCount = 0; }
		};
	...
	protected:
		...
		EventArrayList				mEventList;		
		EventArrayList				mTempRunEventList;
#if USE_SAFT_RELEASE_EVENT
		FreeEventList				mFreeEventList;
		FreeEventList				mTempFreeEventList;
#endif
