...
namespace Logic
{
	...
	public:
		...
		virtual bool WaitTime(float waitTime, EventCallBack callBack = EventCallBack());
		...
		virtual void _setTarget(int target){ mTarget = target; };
		virtual int _getTarget() const { return mTarget; };
	...
	public:
		...
		virtual bool set(const char* szKey, AutoRecord &hRecord);
		...
		virtual bool get(const char* szKey, AutoRecord &hRecord);
	...
	public:
		...
		virtual void setTargetFlag(short flag){ mTargetFlag = flag; }
		virtual short getTargetFlag() const { return mTargetFlag; }

		virtual void setSendTarget(int target){ mUpdateInfo = (void*)(UInt64)target; }
		virtual int getSendTarget() const { return (int)(UInt64)mUpdateInfo; }
