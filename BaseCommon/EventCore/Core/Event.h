...
enum LOGIC_EVENT_STATE
{
	...
	STATE_EVENT_NO_LOG				= 1<<7,			// 不记录日志信息
};
class tNetHandle;
class tNetConnect;
...
namespace Logic
{
	...
	public:
		...
		virtual bool WaitTime(float waitTime, EventCallBack callBack = EventCallBack()) = 0;
		...
		virtual int _getTarget() const = 0;
		virtual void _setTarget(int target) = 0;
	...
	public:
		...
		virtual void setLog(bool bLog){ setState(STATE_EVENT_NO_LOG, !bLog); }
		virtual bool needLog(){ return !hasState(STATE_EVENT_NO_LOG); }
	...
	public:
		...
		virtual bool set(const char* szKey, AutoRecord &hRecord) = 0;
		...
		virtual bool get(const char* szKey, AutoRecord &hRecord) = 0;
	...
	public:
		...
		virtual void setTargetFlag(short flag) = 0;
		virtual short getTargetFlag() const = 0;

		virtual void setSendTarget(int target) = 0;
		virtual int getSendTarget() const = 0;
